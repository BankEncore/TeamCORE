...
class Payroll::PayPeriodWorkweekIntersectionTest < ActiveSupport::TestCase
  test "each_intersecting yields every workweek overlapping pay period" do
    ...
    weeks = Payroll::PayPeriodWorkweekIntersection.each_intersecting(pay_period, workweek_starts_on: 1).to_a
