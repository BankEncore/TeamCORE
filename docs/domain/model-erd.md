...
**Payroll calendar / periods (TC‑23a):** [ADR‑0002](../adr/adr-0002-payroll-period-and-workweek-foundations); roadmap notes under `docs/roadmap/phase-5-payroll-time-leave/`.
